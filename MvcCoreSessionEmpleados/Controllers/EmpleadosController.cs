    ...
    public class EmpleadosController : Controller
    {
        ...
        public async Task<IActionResult> SessionSalarios(int? salario)
        {
            if(salario != null)
            {
                ...
                {
                    //SI YA TENEMOS DATOS ALMACENADOS
                    sumaTotal = HttpContext.Session.GetObject<int>("SUMASALARIAL");
                }
                //SUMAMOS SALARIO NUEVO A LA SUMA TOTAL
        ...
        public async Task<IActionResult> SumaSalarial()
        {
            return View();
        }
        ...
        public async Task<IActionResult> EmpleadosAlmacenadosV5(int? ideliminar)
        {
            ...
            else
            {
                ...
                if(ideliminar != null)
                {
                    ...
                    //SI NO TENEMOS EMPLEADOS EN LA SESSION, NUESTRA COLECCION EXISTE Y SE QUEDA A 0
                    //ELIMINAMOS SESSION
